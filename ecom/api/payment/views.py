...
gateway = braintree.BraintreeGateway(
    braintree.Configuration(
        ...
        merchant_id="tk9v3j6937vhft4c",
        public_key="qbwhypcgzj493yn4",
        private_key="ee7c1763eef143c53e23667276647e59"
    )
)


def validate_user_aession(id, token):
...
def generate_token(request, id, token):
    if not validate_user_aession(id, token):
        return JsonResponse({
